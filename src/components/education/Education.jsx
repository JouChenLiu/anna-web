            ...
            <div className='container education_container'>
                ...
                <div>
                    <article className='education_option'>
                        ...
                        <h3><PiStudentBold size={20} /> Master of Business Administration,</h3>
                        <h3 className="tab">major Management Information System (MIS)</h3>
                ...
                <div>
                    <article className='education_option'>
                        ...
                        <h3 ><PiStudentBold size={20} /> Bachelor of Business Administration,</h3>
                        <h3 className="tab">major Management Information System (MIS)</h3>
